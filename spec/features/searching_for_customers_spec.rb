...
feature 'Searching for customers' do
  def create_customer(first_name: nil, last_name: nil, email: nil)
    first_name ||= Faker::Name.first_name
    last_name ||= Faker::Name.last_name
    email ||=
      "#{Faker::Internet.user_name}#{rand(1000)}@#{Faker::Internet.domain_name}"
  ...
  before(:each) do
    create_customer(first_name: 'Robert', last_name: 'Arron')
    ...
    create_customer(
      first_name: 'Bob', last_name: 'Jones', email: 'bob123@somewhere.net'
    )
